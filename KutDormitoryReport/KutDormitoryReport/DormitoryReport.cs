...
{
    public class DormitoryReport : IDisposable
    {
        public DormitoryReportData Data { get; private set; }
        ...
        internal DormitoryReport(DormitoryReportData data)
        {
            this.Data = data;
        ...
        /// </summary>
        /// <returns></returns>
        internal string Write(DormitoryReportDataStatus status)
        {
        ...
        /// <returns></returns>
        internal string Write(string outputPath, string templatePath, string fontPath, DormitoryReportDataStatus status){
        ...
        private void AddText(PdfReport report, DormitoryReportDataStatus status)
        {
